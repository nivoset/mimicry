...
console.log(await getSelectorDescriptor(await page.getByTestId('product-card-headphones').getByRole('button', { name: 'Add to Cart' })))


console.log(await getFromSelector(page, {
  type: 'testid',
  value: 'product-card-headphones',
